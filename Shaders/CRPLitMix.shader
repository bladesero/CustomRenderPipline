...
#pragma fragment frag
    ...
    float4 frag(vertexOutput input, out float3 GRT0:SV_Target1, out float3 GRT1 : SV_Target2) :SV_TARGET
    {
        ...
        float metal= _MixMap.Sample(sampler_MixMap, input.uv).r;
        float rough= 1- _MixMap.Sample(sampler_MixMap, input.uv).a;
